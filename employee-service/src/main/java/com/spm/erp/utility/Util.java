...
public class Util {
    ...
    public static void sendEmail(Employee employee, String subject, String body) {
        String from = "himanshumahajan381063@gmail.com";
        String pass = "Himanshu123!";
        String[] to = {employee.getEmail(), "himanshumahajan381063@gmail.com"}; // list of recipient email addresses
